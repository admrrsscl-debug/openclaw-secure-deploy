...
4. En el campo de correo, escribe: **`adm.rrss.cl@gmail.com`**.
...
Una vez que hayas compartido tu máquina con `adm.rrss.cl@gmail.com`:

1. **Envía un correo** a `adm.rrss.cl@gmail.com` con:
...
- **El sharing no funciona**: Verifica que escribiste correctamente `adm.rrss.cl@gmail.com`.
